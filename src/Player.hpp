...
namespace v2 {
	...
	public:
		...
		short unknown4B4, unknown4B6, unknown4B8, unknown4BA, unknown4BC, unknown4BE; // 46b9a0: = 0
		...
		char unknown4CC, unknown4CD; // 46b9a0: = 0
		short unknown4CE; // 46b9a0: = 0
		...
		int unknown52C; // 46b9a0: = 0
		float unknown530[12]; // 46b9a0: = {1,1,1,1, 0,1,1,1, 0,0,0,1};
		...
		struct DeckInfo {
			...
			struct CardData {
				...
				char rarity;
				// align 1
				short cellH, cellJ, cellL; // from csv
				char cellI, cellK, cellM; // from csv
				// align 3
				int cellN; // from csv
				short sort;
		...
		struct {
			List<SpriteEx> unknown714; // unsure
			char unknown720 = 5;
			char unknown721;
			short unknown722 = 15;
			char unknown724[4];
		...
		struct InputInfo {
			...
			// offset 0x7B0
			Deque<short> commandInputBuffer;
		...
		char unknown80C[4]; // 48b000: (+80D, +80E) = .0;
		int unknown810, unknown814; // 48b000: = 0;
		...
		virtual bool VUnknown48() = 0;
		virtual bool VUnknown4C(int a) = 0;
		virtual void VUnknown50() = 0;
	...
	class PlayerTenshi    : public Player { public: char unknown890[0xA0]; };
